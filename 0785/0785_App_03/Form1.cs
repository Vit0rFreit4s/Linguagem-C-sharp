...
namespace _0785_App_03
{
    public partial class Form1 : Form
    {
        ...
        private void pic_suricato_Click(object sender, EventArgs e)
        {
            pic_atual.Image = pic_suricato.Image;
            lbl_atual.Text = "Suricato";
        }
        ...
        private void suricatoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pic_suricato_Click(sender, e);
        }
